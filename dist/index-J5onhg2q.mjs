...
function MicroAppName(name) {
  ...
  if (isMicroApp && (window == null ? void 0 : window.__MICRO_APP_NAME__)) {
...
async function initMyMicroApp(app, options, router2, store) {
  ...
  const { initMicroApp } = await import("./initMicroApp-Bd4Pn_m5.mjs");
  ...
  const { initMicroAppMessage } = await import("./index-BwabhMDa.mjs");
